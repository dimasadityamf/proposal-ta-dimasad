...
\begin{center}
  ...
  \textbf{PREDICTION OF CALORIES BURNED WHEN EXERCISE USING \emph{TREADMILL} BASED ON CAMERA AND \emph{SINGLE BOARD COMPUTER}}
\end{center}
...
\begingroup
  ...
  \begin{center}
    ...
    By: \textbf{Dimas Aditya Maulana Fajri} \\
